  ...
  try {
    ...
    if (method === "POST" && event.pathParameters && event.pathParameters.postId && path.includes("/posts/")) {
      ...
      if (!userId || !commentBody) {
        return { statusCode: 400, headers: corsHeaders, body: JSON.stringify({ message: "userId and body required" }) 
        };
      }
    ...
    if (method === "GET" && event.pathParameters && event.pathParameters.commentId && path.includes("/comments/") && !path.includes("/vote")) {
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify(comment) };
    }
    ...
    if (method === "PUT" && event.pathParameters && event.pathParameters.commentId) {
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: "comment updated", updatedAt: now })
      };
    }
    ...
    if (method === "DELETE" && event.pathParameters && event.pathParameters.commentId) {
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: "comment deleted" })
      };
    }
    ...
    if (method === "POST" && event.pathParameters && event.pathParameters.commentId && path.includes("/distinguish")) {
      ...
      if (!userId || !distinguishType) {
        return { statusCode: 400, headers: corsHeaders, body: JSON.stringify({ message: "userId and distinguishType required" }) };
      }
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: "comment distinguished" }) };
    }
    ...
    if (method === "POST" && event.pathParameters && event.pathParameters.commentId && path.includes("/save")) {
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: "comment saved" }) };
    }
    ...
    if (method === "DELETE" && event.pathParameters && event.pathParameters.commentId && path.includes("/save")) {
      ...
      return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: "comment unsaved" }) };
    }
